  ...
  return (
    <Wrapper id="home" className="container flexSpaceCenter">
      ...
      <LeftSide className="flexCenter">
        <div>
        <HeadingTag>
            Property maintenance specialists covering Birmingham & surrounding areas.
          </HeadingTag>
          <h1 className="extraBold font60">We are a Property Maintenance Company.</h1>
          
          
          <HeaderP className="font13 semiBold">
          Looking for reliable property maintenance services in Birmingham & surrouding areas
